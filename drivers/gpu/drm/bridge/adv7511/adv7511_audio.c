...
static void audio_startup(struct device *dev, void *data)
{
	struct adv7511 *adv7511 = dev_get_drvdata(dev);
...
static int adv7511_hdmi_register_audio_driver(struct device *dev)
{
...
{
	return adv7511_hdmi_register_audio_driver(dev);
}
